...
class RendererDefault implements IRenderer {
	...
	public static val X_AXIS_SIZE = 16
	...
	def drawLineIndicatorChart(Indicator<?> indicator, GraphicsContext g, double width, double height, int x, double scaleX) {
		drawLineIndicator(indicator, g, width, height - X_AXIS_SIZE-AXIS_OFFSET, x, scaleX)
